// 파일 경로: app/api/chat/route.ts (Vercel Postgres DB 저장 + TS 오류 수정 최종 버전)

import OpenAI from 'openai';
import { NextResponse } from 'next/server';
import { sql } from '@vercel/postgres'; // Vercel Postgres 라이브러리
...
  try {
    // 테이블과 컬럼 이름들을 모두 큰따옴표(")로 감싸서 문법 오류를 방지합니다.
    await sql`
